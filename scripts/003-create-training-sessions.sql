-- Migration 003: Create training_sessions table for tracking individual training sessions
-- This table stores detailed results from training sessions where children practice specific letters
